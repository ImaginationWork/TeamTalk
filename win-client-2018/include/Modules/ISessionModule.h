...
public:
	...
	*/
    ...
    virtual bool onUpdateRunTimeMsg(const std::string &sid) const = 0;
    virtual void showSession(const std::string &sid) const = 0;
    virtual bool haveSessionLayoutBySId(const std::string &sid) const = 0;
    virtual bool DoDisplayHistoryMsgToIE(const std::string &sid, std::vector<MessageEntity>& msgList, IN const BOOL scrollBottom) const = 0;
	//@}
