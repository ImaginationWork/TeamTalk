...
private:
    ...
    virtual bool onUpdateRunTimeMsg(const std::string &sid) const override;
    virtual void showSession(const std::string &sid) const override;

    virtual bool haveSessionLayoutBySId(const std::string &sid) const override;

    virtual bool DoDisplayHistoryMsgToIE(const std::string &sid, std::vector<MessageEntity>& msgList, IN const BOOL scrollBottom) const override;
